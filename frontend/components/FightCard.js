      ...
      <div className={styles.fighters}>
        <div className={styles.corner}>
          <div className={styles.photo}>
            {redPhoto && <img src={redPhoto} alt={redName} className={styles.img} onError={e => { e.target.style.display='none' }} />}
            <span className={styles.initials}>{initials(redName)}</span>
          </div>
        ...
        <div className={`${styles.corner} ${styles.cornerBlue}`}>
          ...
          <div className={`${styles.photo} ${styles.photoBlue}`}>
            {bluePhoto && <img src={bluePhoto} alt={blueName} className={styles.img} onError={e => { e.target.style.display='none' }} />}
            <span className={styles.initials}>{initials(blueName)}</span>
          </div>
        </div>
      </div>
