          ...
          <div className={styles.heroCenter}>
            ...
            {hasPred && (
              <div className={styles.monteCarlo}>
                ...
                <div className={styles.monteCarloRow}><span>Decision</span><span>{Math.round((pred.decision_probability || 0) * 100)}%</span></div>
                <div className={styles.monteCarloRow}><span>KO / TKO</span><span>{Math.round((pred.ko_probability || 0) * 100)}%</span></div>
                <div className={styles.monteCarloRow}><span>Submission</span><span>{Math.round((pred.submission_probability || 0) * 100)}%</span></div>
              </div>
            )}
            {hasPred && (
                ...
                return (
                  <div key={label} className={styles.statRow}>
                    ...
                    <div className={styles.statCenter}>
                      ...
                      <div className={styles.statBar}><div className={styles.statBarFill} style={{ '--pct': `${Math.round(redPct * 100)}%` }} /></div>
                    </div>
                ...
                return (
                  <div key={key} className={styles.shapRow}>
                    ...
                    <div className={styles.shapBarWrap}>
                      <div className={styles.shapBar} style={{ width, background: favorsRed ? '#e3000f' : '#1a6fc4', marginLeft: favorsRed ? 'auto' : '0' }} />
                    </div>
